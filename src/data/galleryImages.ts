...
export const galleryImages: GalleryImage[] = [
  {
    id: 1,
    title: 'Our Store',
    description: 'Selvakkodi Agro Service in Thandarampattu, Tiruvannamalai',
  ...
  },
  {
    ...
    description: 'Curated agricultural seeds, fertilizers, crop care, and services',
  ...
  },
  {
    ...
    description: 'Thoughtful agro service for every customer',
