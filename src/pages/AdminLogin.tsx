    ...
    <div className="relative min-h-screen overflow-hidden bg-[#F9FAFB] px-4 py-8 font-sans text-[#111111] sm:px-6 lg:flex lg:items-center lg:justify-center">
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-[#A7F3D0] bg-white shadow-[0_24px_80px_rgba(44,57,42,0.14)] lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="mb-8 flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <p className="text-[11px] font-black uppercase tracking-[0.24em] text-[#2E7D32]">{BRAND_SUBTITLE}</p>
          ...
          <p className="mt-4 inline-flex items-center gap-2 rounded-full border border-[#A7F3D0] bg-[#FBFAF6] px-3 py-1.5 text-[11px] font-black uppercase tracking-wider text-[#2E7D32]">
            <ShieldCheck size={13} />
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border-2 border-[#A7F3D0] bg-[#FBFAF6] px-4 py-3.5 text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#2E7D32] focus:bg-white"
              value={portalId}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border-2 border-[#A7F3D0] bg-[#FBFAF6] px-4 py-3.5 pr-12 text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#2E7D32] focus:bg-white"
                value={password}
          ...
          <button
            type="submit"
            disabled={loading}
            className="group flex w-full items-center justify-center gap-2 rounded-2xl bg-[#2E7D32] py-3.5 font-black text-white shadow-lg shadow-[#2E7D32]/20 transition-colors hover:bg-[#1B5E20] disabled:opacity-60"
          >
            {loading ? (
              <>
