      ...
      >
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.26em] text-[#2E7D32] mb-4">
            Selvakkodi Agro Service
          </p>
          <h1 className="text-[2.8rem] sm:text-[3.6rem] font-black text-[#111111] tracking-tight leading-[1.02] mb-4">
            Inside Our Store
          </h1>
          <p className="text-[16px] sm:text-[18px] font-black text-[#2E7D32] mb-4">
            Quality Agro Services & Products
          </p>
          ...
          {galleryImages.map((img, idx) => (
            ...
            >
              <div className="relative overflow-hidden rounded-[20px] sm:rounded-[24px]
                ...
                transition-shadow duration-300 bg-[#A5D6A7]/20">
                <img
                  src={img.image}
                  alt={img.title}
                  loading="lazy"
