...
export default function Products() {
  ...
  const SkeletonCard = () => (
    <div className="rounded-2xl border border-[#A5D6A7]/50 bg-white overflow-hidden animate-pulse">
      <div className="aspect-square bg-[#A5D6A7]/30" />
      <div className="p-3 space-y-2">
        <div className="h-2 bg-[#A5D6A7]/40 rounded w-1/2" />
        <div className="h-3 bg-[#A5D6A7]/40 rounded w-4/5" />
        <div className="h-3 bg-[#A5D6A7]/30 rounded w-3/5" />
        <div className="flex gap-1 mt-2">
          {[1,2,3,4].map(i => <div key={i} className="h-5 bg-[#A5D6A7]/30 rounded-lg w-10" />)}
        </div>
        <div className="flex justify-between items-center pt-2 border-t border-[#A5D6A7]/30 mt-2">
          <div className="h-5 bg-[#A5D6A7]/40 rounded w-14" />
          <div className="h-8 bg-[#A5D6A7]/40 rounded-xl w-16" />
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="bg-bgMain min-h-screen">
      {/* Header Panel */}
      <div className="bg-white border-b border-[#A5D6A7]/30">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-grow">
          ...
          {loading ? (
            ...
            <div className="bg-white border border-[#A5D6A7]/40 rounded-3xl p-10 sm:p-20 text-center flex flex-col items-center">
               <div className="w-20 h-20 bg-[#F9FAFB] rounded-full flex items-center justify-center mb-6">
                 <Search className="text-[#A5D6A7]" size={32}/>
               </div>
          ...
          <div className="mt-12 p-6 sm:p-8 bg-green-50 border border-green-100 rounded-3xl flex flex-col sm:flex-row items-center gap-6">
             ...
             <div>
                <h4 className="font-black text-lg text-green-900 leading-tight">Selvakkodi Agro Service Quality</h4>
                <p className="text-sm text-green-700 mt-1">Every product in our collection is sourced directly from trusted producers and verified for quality.</p>
             </div>
          </div>
        </div>
      </div>
